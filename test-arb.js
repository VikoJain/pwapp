...
test('high house consumption leaves no surplus (never dumps in the cheap morning)', () => {
  ...
  const heavy = planSellSlots({ rates, pctForPlan: 100, planFloorPct: 30, minuteOfDay: 330, cRateForSell: 0.8 });
  // Normal drain (0.3): a real surplus survives to the evening → sold at the top evening slots.
  const normal = planSellSlots({ rates, pctForPlan: 100, planFloorPct: 30, minuteOfDay: 330, cRateForSell: 0.3 });
